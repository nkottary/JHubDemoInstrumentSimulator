...
- The DB service endpoint is hardcoded in src/InstrumentSimulator.jl. Ideally this should be configured as an environment variable but that feature is not available right now.
